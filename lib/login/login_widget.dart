...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signupPsswordTextController ??= TextEditingController();
    _model.signupPsswordFocusNode ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/taskrus-high-resolution-logo.png',
                        width: 120.0,
                        fit: BoxFit.cover,
                      ),
                    ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signupPsswordTextController,
                                          focusNode:
                                              _model.signupPsswordFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText:
                                              !_model.signupPsswordVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                        ...
                        if (_model.tabBarCurrentIndex == 0)
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signupPsswordTextController.text !=
                              ...
                              final user =
                                ...
                                _model.signupPsswordTextController.text,
                              );
                              if (user == null) {
                                return;
                              }
